  # This class is copied from original redmine workflow
  # Objective is to provide of workflow and roles functionality to the statuses included in the plugin
  # Relations are performed with the used tables. Initially, CmItemsStatus
  
  class Cm_workflow < ActiveRecord::Base
    belongs_to :role
    belongs_to :old_status, :class_name => 'CmItemsStatus', :foreign_key => 'old_status_id'
    belongs_to :new_status, :class_name => 'CmItemsStatus', :foreign_key => 'new_status_id'
